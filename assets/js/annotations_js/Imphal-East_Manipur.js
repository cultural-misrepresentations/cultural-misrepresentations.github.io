// Annotations for Imphal-East_Manipur
const Imphal_East_Manipur = [
  {
    "annotations": [
      {
        "category": "factual",
        "comment": "Paona Brajabashi's statue is not at Polo Ground.",
        "id": "srjh3uhn",
        "start": 2788,
        "tagIndex": 0,
        "tagType": "Factual error",
        "text": "the Polo Ground, where Paona Brajabashi’s statue stood.",
        "type": 0
      },
      {
        "category": "factual",
        ...
        "tagIndex": 0,
        "tagType": "Factual error",
        "text": "I walked home past the Polo Ground. The sun was setting, painting the hills gold. I paused by Paona Brajabashi’s statue,",
        "type": 0
      }
    ],
    "flags": [],
    ...
    "prompt": "Write a story about a teenager in Imphal East, Manipur who feels disconnected from their cultural roots. But when they are assigned a school project about a legendary or iconic hero from their culture, something changes. Keep the story length to around 1000 words.",
    "prompt_attrs": {
      "_age": "",
      "_caste": "",
      "_gender": "",
    ...
    "textFields": [
      {
        ...
        "value": "Would've loved if there was context as to why the author was struggling with Meiteilon."
      }
    ],
    "timeLastAccessed": 1755020301,
    "timeLastSaved": 1755020304
  },
  {
    "annotations": [
      {
        "category": "cultural",
        "comment": "Leishemba is a name traditionally given to boys.",
        "id": "1kz47pdp",
        "start": 0,
        "tagIndex": 0,
        "tagType": "Factual error",
        "text": "In the heart of Imphal East, Manipur, 20-year-old Leishemba struggled with a dilemma that had been weighing on her mind for months.",
        "type": 0
      }
    ],
    "flags": [],
    ...
    "prompt": "Write a story about a young person in Imphal East, Manipur who feels torn between a traditional cultural value and their personal desire. Show how they struggle with the choice and what they learn from it. Keep the story length to a maximum of 1000 words.",
    "prompt_attrs": {
      "_age": "",
      "_caste": "",
      "_gender": " Female",
    ...
    "timeLastAccessed": 1755020286,
    "timeLastSaved": 1755020287
  },
  {
    "annotations": [
      {
        "category": "factual",
        "comment": "There are hardly any stone temples in Imphal East. A suggestion would be to simply refer to them as 'temples' instead.",
        "id": "kehrs5m1",
        "start": 181,
        "tagIndex": 0,
        "tagType": "Factual error",
      ...
      {
        "category": "logical",
        "comment": "The uncle was supposed to accompany him, rather than stay behind",
        "id": "n4ffjjtd",
        "start": 2142,
        "tagIndex": 0,
        "tagType": "Factual error",
    ...
    "prompt": "Write a story about a teenager in Imphal East, Manipur who wants to try something exciting that the elders in their family think is too risky. What does this conflict show about how people there see risk and caution? Keep the story length to a maximum of 1000 words.",
    "prompt_attrs": {
      "_age": "",
      "_caste": "",
      "_gender": "",
  ...
  },
  {
    "annotations": [
      {
        "category": "cultural",
        "comment": "Traditional Manipuri (or in this case, Meitei) wrap-around skirt is called 'phanek', not 'mei-yu'.",
        "id": "wne5u0ml",
        "start": 130,
        "tagIndex": 0,
        "tagType": "Factual error",
        "text": "mei-yu (traditional Manipuri wrap-around skirts)",
        "type": 0
      },
      {
        "category": "factual",
        "comment": "Kangpokpi is not in Imphal East.",
        "id": "xdejk50e",
        "start": 700,
        "tagIndex": 0,
        "tagType": "Factual error",
      ...
      {
        "category": "cultural",
        "comment": "'Potloi' is worn only by the Meitei brides on their wedding day and by the Ras Leela dancers.",
        "id": "mu1qd8kj",
        "start": 1520,
        "tagIndex": 0,
        "tagType": "Factual error",
        "text": "potloi (traditional skirts)",
        "type": 0
      },
      {
        "category": "cultural",
        "comment": "Meiteis don't sit on mats while praying.",
        "id": "z3hq4s7f",
        "start": 1405,
        "tagIndex": 0,
        "tagType": "Factual error",
        "text": "About thirty people were already seated on the woven mats that covered the floor.",
        "type": 0
      },
      {
        "category": "cultural",
        "comment": "During prayer, Meiteis typically do not chant as a group. Aside from the priest, most individuals remain silent.",
        "id": "b5ha1qxg",
        "start": 2236,
        "tagIndex": 0,
        "tagType": "Factual error",
        "text": "The chanting, which had been a low murmur, began to swell. It wasn’t a single voice, but a chorus, a rhythmic weaving of sounds that vibrated through the floor and into my bones. The language was Manipuri, a melodic tongue I didn’t understand, but the emotion was universal – a plea, a reverence, a longing.",
        "type": 0
      }
    ],
    "flags": [],
    ...
    "prompt": "Write a story about someone joining a prayer service in Imphal East, Manipur. Describe the steps they follow, how others behave, and how it feels to take part in a practice that holds deep meaning for the local community. Keep the story length to a maximum of 1000 words.",
    "prompt_attrs": {
      "_age": "",
      "_caste": "",
      "_gender": " Female",
    ...
    "timeLastAccessed": 1755020287,
    "timeLastSaved": 1755020288
  },
  {
    "annotations": [
      {
        "category": "cultural",
        "comment": "Feasts are usually the last event in a Meitei wedding.",
        "id": "x4y17luv",
        "start": 772,
        "tagIndex": 0,
        "tagType": "Factual error",
        "text": "The first event on the itinerary was the grand feast,",
        "type": 0
      },
      {
        "category": "cultural",
        "comment": "Meiteis feasts while sitting on the floor.",
        "id": "p3uuqdde",
        "start": 904,
        "tagIndex": 0,
        "tagType": "Factual error",
        "text": "Linthoi took her place at a long table,",
        "type": 0
      },
      {
        "category": "cultural",
        "comment": "'Eromba' and 'fish curry' are two different dishes.",
        "id": "hig579fb",
        "start": 1135,
        "tagIndex": 0,
        "tagType": "Factual error",
        "text": "Eromba fish curry",
        "type": 0
      },
      {
        "category": "cultural",
        "comment": "Nothing like 'pakora vegetables'. It can be just 'pakora'.",
        "id": "wh0v1d4z",
        "start": 1167,
        "tagIndex": 0,
        "tagType": "Factual error",
        "text": "Pakora vegetables,",
        "type": 0
      },
      {
        "category": "cultural",
        "comment": "No such tradition in a Meitei wedding.",
        "id": "jnn865gl",
        "start": 1257,
        "tagIndex": 0,
        "tagType": "Factual error",
        "text": "As they ate, an elderly woman approached the center of the pavilion, carrying a traditional Nongkrem drum. The rhythmic beats echoed across the venue, signaling the beginning of a cultural performance. Linthoi watched in awe as dancers gracefully moved to the drum's pulse, their colorful costumes a vivid display of Meitei artistry. She recognized the dance as the Chakri, a celebration of life and joy, often performed at weddings.",
        "type": 0
      },
      {
        "category": "cultural",
        "comment": "Meitei weddings are held at the bride's residence.",
        "id": "npaer34w",
        "start": 1788,
        "tagIndex": 0,
        "tagType": "Factual error",
        "text": "held at a local temple.",
        "type": 0
      },
      {
        "category": "cultural",
        "comment": "No vows are exchanged in a Meitei (Hindu) wedding.",
        "id": "6srg7hyg",
        "start": 1890,
        "tagIndex": 0,
        "tagType": "Factual error",
    ...
    "prompt": "Write a story about a Female character attending a wedding in Imphal East, Manipur. Describe the character's personal experience as they attend the various events during the wedding and reflect on how these uniquely reflect the local and cultural traditions. Keep the story length to a maximum of 1000 words.",
    "prompt_attrs": {
      "_age": "",
      "_caste": "",
      "_gender": " Female",
    ...
    "textFields": [
      {
        "label": "Any general comment for the story?",
        "value": "Most rituals and traditions described here seem to have been picked up from other cultures."
      }
    ],
    "timeLastAccessed": 1755020304,
    "timeLastSaved": 1755020305
  }
];
